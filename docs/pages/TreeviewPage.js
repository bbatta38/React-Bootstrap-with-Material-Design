...
class TreeviewPage extends Component {
  ...
  render() {
    return (
      <MDBContainer>
        <DocsLink title='Tabs' href='https://mdbootstrap.com/plugins/react/treeview/' />
        <SectionContainer header='Basic example'>
          <MDBCol md='4'>
            <MDBTreeview header='Folders' className='w-20' getValue={value => console.log(value)}>
        ...
        <SectionContainer header='Animated'>
          <MDBCol md='4'>
            <MDBTreeview theme='animated' header='Folders' className='w-20' getValue={value => console.log(value)}>
          ...
          <MDBRow>
            <MDBCol md='4'>
              ...
              >
                ...
                <MDBTreeviewList
                  icon='folder-open'
                  title='Opened and disabled folder'
                  opened
                  disabled
