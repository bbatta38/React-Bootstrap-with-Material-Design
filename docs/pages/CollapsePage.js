...
import { MDBBtn, MDBCollapse, MDBContainer } from 'louis-mdbreact';
...
class CollapsePage extends Component {
  ...
  render() {
    ...
    return (
      <MDBContainer>
        <DocsLink title='Collapse' href='https://mdbootstrap.com/docs/react/advanced/collapse/' />
        ...
        <SectionContainer header='Accordion without icon'>
          <div>
            <div>
              <MDBBtn color='primary' onClick={this.toggleCollapse('accordion1')} style={{ marginBottom: '1rem' }}>
            ...
            <div>
              <MDBBtn color='primary' onClick={this.toggleCollapse('accordion2')} style={{ marginBottom: '1rem' }}>
            ...
            <div>
              <MDBBtn color='primary' onClick={this.toggleCollapse('accordion3')} style={{ marginBottom: '1rem' }}>
                Collapsible Group Item #2
              </MDBBtn>
            </div>
